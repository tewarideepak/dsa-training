...
long long find_sum(const vector<int> &arr)
{
    long long sum = 0;
    for (int x : arr)
    {
...
bool isPossibleSol(const vector<int> &time, int m, int n, long long mid)
{
    long long daysCount = 1;
    long long timesCount = 0;
